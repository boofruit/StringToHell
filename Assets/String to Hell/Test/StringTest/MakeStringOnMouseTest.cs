...
namespace StringToHell.Test.StringTest
{
    public class MakeStringOnMouseTest : MonoBehaviour
    {
        ...
        //        unwind.StartThread(anchorObj.GetComponent<Rigidbody2D>(),GetComponent<SpringJoint2D>());
        ...
        //        }
        //        unwind.AddSegment( segmentSpacing, maxSegementsLength, frequency, dampingRatio);
